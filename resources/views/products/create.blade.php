                ...
                <div class="card">
                    <div class="card-header">
                        <div class="flex">
                            ...
                            <a href="{{ route('product.index') }}" class="mt-4 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mx-4">
                                Back
                            </a>
                        </div>                        
                    </div>
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('product.store') }}">
                            ...
                            <div class="p-5">
                                ...
                                <input type="text" name="description" class="block mt-1 rounded-md border-gray-300 w-full">
                                @error('description')
                                <small class="text text-red-500">{{$message}}</small>
                            @enderror
                            </div>
                            <div class="p-5">
                                ...
                                <input type="integer" name="unit_price" class="block mt-1 rounded-md border-gray-300 w-full">
                                @error('unit_price')
                                <small class="text text-red-500">{{$message}}</small>
                            @enderror
                            </div>
                            ...
                            <div class="p-5 flex justify-between items-center">
                                <a href="{{ route('product.cancel') }}" class="bg-red-600 p-3 rounded text-white">Annuler</a>
